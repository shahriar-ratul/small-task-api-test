    ...
    try {
      ...
      if (result.isConfirmed) {
        ...
        if (data.success) {
          ...
          MySwal.fire("Error!", data.message.toString(), "error");
        }
      ...
      if (error.response) {
        MySwal.fire("Error!", error.response.data.message.toString(), "error");
      } else {
      ...
      render: (text: any, record: any) => {
        return (
          <Space size="middle" align="center">
            {ability.can("role.active", "") && record.slug !== "superadmin" ? (
              <Space size="middle" align="center" wrap>
                <Checkbox
          ...
          <>
            <Space size="middle" align="center">
              ...
              record.slug !== "superadmin" ? (
                <Space size="middle" align="center" wrap>
                  <Link
                    href={`/admin/settings/user-management/role/${record.id}/edit`}
                  >
      ...
      <AppRowContainer>
        <Col span={24} key="data-f">
          ...
          <TableCard
            title="Roles List"
            hasLink={true}
            addLink="/admin/settings/user-management/role/create"
