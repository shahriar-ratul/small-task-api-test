...
import type { DepartmentModel } from "@/interfaces/DepartmentModel";
...
const EditDepartmentForm = ({ item }: PropData) => {
  // ** States
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      await AppAxios.put(`/api/v1/departments/${item.id}`, formData)
        .then(res => {
          const { data } = res;
